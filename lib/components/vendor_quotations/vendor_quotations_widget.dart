    ...
    return StreamBuilder<List<ChatsRecord>>(
      stream: queryChatsRecord(
        queryBuilder: (chatsRecord) => chatsRecord
            ...
            .where('customer_ref', isEqualTo: widget.rfqDocument!.customerRef)
      ...
      builder: (context, snapshot) {
        ...
        final rowChatsRecord =
            rowChatsRecordList.isNotEmpty ? rowChatsRecordList.first : null;
        return Row(
            ...
            Expanded(
              child: FutureBuilder<UsersRecord>(
                future: UsersRecord.getDocumentOnce(
                    widget.rfqDocument!.customerRef!),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model
                                    .deliveryDaysControllerValidator
                                    .asValidator(context),
                                inputFormatters: [
                                    ...
                                    onPressed: () async {
                                      final quotationCreateData = {
                                        ...createQuotationRecordData(
                                          deliverInDays: int.tryParse(_model
