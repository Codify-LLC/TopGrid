...
export 'add_new_customer_model.dart';

class AddNewCustomerWidget extends StatefulWidget {
  const AddNewCustomerWidget({Key? key}) : super(key: key);
...
class _AddNewCustomerWidgetState extends State<AddNewCustomerWidget> {
  late AddNewCustomerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewCustomerModel());
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          // Admin Contact Number Text Field
                                          Semantics(
                                            label:
                                                'Admin Contact Number Text Field',
                                            child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Semantics(
                                            label: 'Admin Username Text Field',
                                            child: Container(
                                              width: 600.0,
                                              child: TextFormField(
                                                controller: _model
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        onTap: () async {
                                          // User will input all information in the textfield related to Company Which is being added by user.
                                          ...
                                          // User will input all the information related to  user that is being added to topgrid.
                                          // Information of user
