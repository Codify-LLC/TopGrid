                                ...
                                return SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: List.generate(
                                        columnPartRecordList.length,
                                        (columnIndex) {
                                      final columnPartRecord =
                                          columnPartRecordList[columnIndex];
                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      if (_model.vendorDropDown)
                                                        MultipleSelectionDropDownWidget(
                                                          key: Key(
                                                              'Keysfx_${columnIndex}_of_${columnPartRecordList.length}'),
                                                          optionsList:
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    wrapWithModel(
                                                      ...
                                                      updateCallback: () =>
                                                          setState(() {}),
                                                      child: PartQuantityWidget(
                                                        key: Key(
                                                          'Keykyt_${random_data.randomString(
                                                            1,
                                                            10,
                                                            true,
                                                            true,
                                          ...
                                          FlutterFlowDropDown<String>(
                                            ...
                                            onChanged: (val) => setState(() =>
                                                _model.selectRequirementTypeValueMap[
                                                    columnPartRecord] = val!),
                                                ...
                                                children: [
                                                  wrapWithModel(
                                                    ...
                                                    child:
                                                      ...
                                                      key: Key(
                                                        'Key2pa_${random_data.randomInteger(0, 10).toString()}',
                                                      ),
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        ...
                                                        if (_model.selectRequirementTypeValueMap[
                                                                columnPartRecord] ==
                                                            null) {
