...
/// Functions to query RequestForQuotationRecords (as a Stream and as a Future).
Future<int> queryRequestForQuotationRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RequestForQuotationRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RequestForQuotationRecord>> queryRequestForQuotationRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<RequestForQuotationRecord>> queryRequestForQuotationRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<RequestForQuotationRecord>>
    queryRequestForQuotationRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query CompanyUsersRecords (as a Stream and as a Future).
Future<int> queryCompanyUsersRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CompanyUsersRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CompanyUsersRecord>> queryCompanyUsersRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<CompanyUsersRecord>> queryCompanyUsersRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<CompanyUsersRecord>> queryCompanyUsersRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
