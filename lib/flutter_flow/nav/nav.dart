...
class AppStateNotifier extends ChangeNotifier {
  TopgridFirebaseUser? initialUser;
  TopgridFirebaseUser? user;
  ...
  void update(TopgridFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => EmailVerificationLinkWidget(),
            ),
            FFRoute(
              name: 'Login',
              path: 'login',
            ...
            FFRoute(
              ...
              path: 'createNewRFQ',
              requireAuth: true,
              builder: (context, params) => CreateNewRFQWidget(
                parts: params.getParam('parts', ParamType.bool),
              ),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => EditCompanyProfileWidget(),
            ),
            FFRoute(
              name: 'RCPtabbar',
              path: 'rCPtabbar',
              requireAuth: true,
              builder: (context, params) => RCPtabbarWidget(
